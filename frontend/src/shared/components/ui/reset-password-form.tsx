...
interface ResetPasswordFormProps {
  ...
  onCancel?: () => void;
  onPasswordChange?: (password: string, showPassword: boolean) => void;
}
            ...
            <div className="flex justify-center space-x-2" onPaste={handlePaste}>
              {Array.from({ length: 6 }).map((_, index) => (
                <Input
                  ...
                  className="h-12 w-12 text-center text-lg font-semibold bg-background border-border/60 focus:border-primary"
                  ...
                  <div className="relative">
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        onPasswordChange?.(e.target.value, showPassword);
                      }}
                      onFocus={() => onPasswordChange?.(password, showPassword)}
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        onPasswordChange?.(password, newShowPassword);
                      }}
