...
import { VerticalCutReveal } from "@/shared/components/ui/vertical-cut-reveal";
import { ArrowRight, Brain, Sparkles, Database, BarChart3 } from "lucide-react";
...
export default function AboutSection1() {
  ...
  return (
    <section
      id="about"
      className="relative py-32 px-4 bg-background overflow-hidden scroll-mt-20"
      ref={heroRef}
    >
      ...
      <TimelineContent
        ...
        style={{
          backgroundImage: `
        radial-gradient(125% 125% at 50% 90%, rgba(0, 217, 255, 0.1) 40%, rgba(19, 19, 19, 0) 100%)
      `,
      ...
      />
      <TimelineContent
        className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,rgba(163,163,163,0.1)_1px,transparent_1px),linear-gradient(to_bottom,rgba(163,163,163,0.1)_1px,transparent_1px)] bg-[size:70px_70px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_100%,#000_70%,transparent_110%)]"
        animationNum={3}
        customVariants={revealVariants3}
        timelineRef={heroRef}
      />
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            From day one, our mission has been to demystify machine learning and make AI transparent. 
            We empower users to build, train, and understand ML models with complete explainability, 
            ensuring every prediction comes with clear, human-understandable insights.
          </p>
        </div>
        ...
        >
          <Button
            asChild
            size="lg"
            className="bg-primary hover:bg-primary/90 shadow-lg shadow-primary/50 border border-primary flex w-fit gap-2 hover:gap-4 transition-all duration-300 ease-in-out text-primary-foreground px-5 py-3 rounded-full"
          >
            <Link to="/register">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-4 gap-4 pt-20 lg:h-[26rem] md:h-[22rem] sm:h-[16rem] h-[14rem]">
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2700&auto=format&fit=crop&ixlib=rb-4.1.0"
            alt="ML Dashboard"
            width={128}
            height={160}
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1555949963-aa79dcee981c?q=80&w=3276&auto=format&fit=crop&ixlib=rb-4.1.0"
