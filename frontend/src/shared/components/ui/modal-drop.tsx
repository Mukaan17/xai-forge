...
const Modal: React.FC<ModalProps> = ({
  ...
  const getModalClasses = () => {
    const base =
      "w-auto bg-background/80 backdrop-blur-xl border border-border/50 text-card-foreground max-w-[90%] sm:max-w-2xl rounded-2xl shadow-2xl m-4 relative"
    return type === "overlay" ? base : `${base} border border-border/50`
  }
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className={cn(getModalClasses(), "relative", className)}
              ...
              >
                ...
                {showCloseButton && (
                  ...
                  >
                    ...
                    <button
                      className="p-1 rounded-md transition-colors pointer-events-auto hover:text-destructive"
                      onClick={(e) => {
                        e.stopPropagation();
                        onClose();
                      }}
