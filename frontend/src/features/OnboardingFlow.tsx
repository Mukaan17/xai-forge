...
import { ArrowRight, ArrowLeft, Upload, BrainCircuit, Sparkles, BookOpen, Database } from 'lucide-react';
...
export function OnboardingFlow({ onComplete, onSkip }: OnboardingFlowProps) {
  ...
  const handleLoadSample = () => {
    // Navigate to datasets page - sample dataset loading can be implemented there
    navigate('/datasets');
    onComplete();
  };

  const handleUploadOwn = () => {
    // Navigate to datasets page for upload
    navigate('/datasets');
    onComplete();
  };
      ...
      <div className="w-full max-w-3xl bg-card border border-border rounded-xl shadow-2xl overflow-hidden">
        ...
        {step === 2 && (
          <div className="p-12">
            ...
            <div className="relative bg-gradient-to-br from-background to-muted/30 rounded-lg p-8 mb-8 min-h-[400px] flex items-center justify-between border border-border">
              {/* Sidebar Preview */}
              <div className="w-56 h-96 bg-card border border-border rounded-lg p-4 shadow-xl">
              ...
              <div className="max-w-md ml-8">
                <div className="bg-card border-2 border-primary/30 rounded-lg p-6 shadow-xl">
        ...
        {step === 3 && (
          <div className="p-12 text-center">
              ...
              <div className="p-6 border-2 border-primary/30 bg-primary/5 rounded-lg hover:border-primary/50 transition-colors">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <Button onClick={handleLoadSample} className="bg-primary text-primary-foreground hover:bg-primary/90">
                      Load Sample Dataset
                    </Button>
                  </div>
                </div>
            ...
            <Button onClick={handleUploadOwn} variant="outline" size="lg">
        ...
        {step === 4 && (
          <div className="p-12 text-center">
            ...
            <div className="max-w-md mx-auto space-y-4 mb-8">
              ...
              <Button 
                onClick={() => { navigate('/datasets'); onComplete(); }} 
                variant="outline" 
                className="w-full justify-start h-auto p-4 hover:border-primary/30"
              >
              ...
              <Button 
                onClick={() => { navigate('/models'); onComplete(); }} 
                variant="outline" 
                className="w-full justify-start h-auto p-4 hover:border-primary/30"
              >
              ...
              <Button 
                onClick={() => window.open('https://docs.xai-forge.com', '_blank')} 
                variant="outline" 
                className="w-full justify-start h-auto p-4 hover:border-primary/30"
              >
